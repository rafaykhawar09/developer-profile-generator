...
function setUserInfo(axiosResult) {
     ...
     userInfo.gitHubLink = axiosResult.data.html_url;
          ...
          <div class="wrapper">
               <div class="container">
                    <div class="photo-header">
                         ...
                         <div class="links-nav">
                              <div class="nav-link">
                                   <a href="https://www.google.com/maps/place/${userInfo.location}/"><i class="fas fa-location-arrow"></i> Location</a>
                              </div>
                              <div class="nav-link">
                                   <a href="${userInfo.gitHubLink}"><i class="fab fa-github-alt"></i> GitHub</a>
                              </div>
                              <div class="nav-link">
                                   <a href="${userInfo.blog}"><i class="fas fa-rss"></i> Blog</a>
                              </div>
                         </div>
                    </div>
               </div>
